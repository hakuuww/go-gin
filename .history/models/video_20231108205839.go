...
Unmarshaling:
	...
	Go can unmarshal it into a Video struct by matching the JSON keys to the struct field names defined in the tags. This allows you to work with the data in your Go code more easily.
*/
type Video struct {
	Id int 
