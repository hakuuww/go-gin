...
func (c controller) Create (context *gin.Context){
	video := models.Video{Id:g.getNextVideoId()}

	//MustBindWith binds the passed struct pointer using the specified binding engine. It will abort the request with HTTP 400 if any error occurs.
